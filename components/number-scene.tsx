...
const numbers: NumberItem[] = [
  { id: "1", number: 1, nameJapanese: "いち", nameEnglish: "one", color: "#FF6B6B" },
  { id: "2", number: 2, nameJapanese: "に", nameEnglish: "two", color: "#4ECDC4" },
  { id: "3", number: 3, nameJapanese: "さん", nameEnglish: "three", color: "#45B7D1" },
  { id: "4", number: 4, nameJapanese: "よん", nameEnglish: "four", color: "#96CEB4" },
  { id: "5", number: 5, nameJapanese: "ご", nameEnglish: "five", color: "#FFEAA7" },
  { id: "6", number: 6, nameJapanese: "ろく", nameEnglish: "six", color: "#DDA0DD" },
  { id: "7", number: 7, nameJapanese: "なな", nameEnglish: "seven", color: "#98D8C8" },
  { id: "8", number: 8, nameJapanese: "はち", nameEnglish: "eight", color: "#F7DC6F" },
  { id: "9", number: 9, nameJapanese: "きゅう", nameEnglish: "nine", color: "#BB8FCE" },
  { id: "10", number: 10, nameJapanese: "じゅう", nameEnglish: "ten", color: "#85C1E9" },
]
      ...
      <div className="grid grid-cols-5 gap-6 justify-items-center">
        {numbers.map((number) => (
          ...
          >
            ...
            >
              {/* Number Display */}
              <div className="text-5xl font-bold text-white mb-2 drop-shadow-lg">{number.number}</div>

              {/* Japanese Name */}
              <div className="text-sm font-bold text-white bg-black/20 px-2 py-1 rounded">{number.nameJapanese}</div>
            ...
            {/* Dots for counting */}
            <div className="mt-3 flex flex-wrap justify-center gap-1 max-w-24">{generateDots(number.number)}</div>
